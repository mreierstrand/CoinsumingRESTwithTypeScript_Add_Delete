...
new Vue({
    ...
    methods: {
        ...
        deleteTransporter: function (deleteId) {
            var _this = this;
        ...
        addTransporter: function () {
            ...
            var addLastbilElement = document.getElementById("addLastbil");
            var addChaufførElement = document.getElementById("addChaufførNavn");
            var addDatoElement = document.getElementById("addDato");
            var addAntalKmElement = document.getElementById("addAntalKm");
            var addGennemsnitElement = document.getElementById("addGennsmsnit");
            var myID = Number(addIdElement.value);
            var myLastbil = addLastbilElement.value;
            var myChauffør = addChaufførElement.value;
            var myDato = addDatoElement.value;
            var myAntalKm = Number(addAntalKmElement.value);
            var myGennemsnit = Number(addGennemsnitElement.value);
            // axios.post<ITransporter>(baseUrl, this.formData)
            _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(baseUrl, { id: myID, lastbil: myLastbil, chaufførNavn: myChauffør, dato: myDato, antalKm: myAntalKm, gennsmsnit: myGennemsnit })
                .then(function (response) {
